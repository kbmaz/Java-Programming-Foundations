...
public class ShapeMouseHandler extends MouseAdapter {
     ...
     shape = model.returnSelectShape(e.getX(), e.getY());
       ...
       if(shape != null) {
         ...
         //On mouse click remove shape from ArrayList
           ...
           if (shape instanceof Rectangle) {
            ((Rectangle) shape).setFillColor(model.getFColor());
           }
           if (shape instanceof Triangle) {
             ((Triangle) shape).setFillColor(model.getFColor());
            }
         } 
       }
     }
  ...
  public void mouseDragged(MouseEvent e) {
    ...
    model.getCurrentShape();
      ...
      if(shape != null){
        ...
        if(model.getAction() == Model.Action.MOVE || model.getAction() == Model.Action.RESIZE) {
          //shape.setLineColor(model.getCurrentLineColor().darker());
          //darkShade = lineColor.darker();
          //darkShade = model.getCurrentLineColor().darker();
          //setDarkShade(shape.getLineColor().darker());
        }
       ...
       //& distances from mouse point to all shape points
           ...
           //Move start point to move entire shape
  ...
  public void setDarkShade(Color darkShade) {
